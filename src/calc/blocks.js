...
var MovingBlock = cc.Node.extend({
    ...
    fadeToColor: function(color){
        var tcolor = Util.hexToColor( color, 255 );
        var tintto = new cc.TintTo(0.1,tcolor.r,tcolor.g,tcolor.b);
        this.sprite.runAction(tintto);
    },
    fadeRemove: function(){
...
*/
        ...
        this.helloLabel = new cc.LabelTTF(""+number, gameFont, fontsize*1.6, cc.size(width*2,height*2), cc.TEXT_ALIGNMENT_CENTER, cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
